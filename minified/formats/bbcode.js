/* SCEditor v2.1.3 | (C) 2017, Sam Clarke | sceditor.com/license */ ! function(t) {
    "use strict";
    var h = t.escapeEntities,
        ...
        k = {
            ...
            font: {
                ...
                format: function(t, e) {
                    var n;
                    return v(t, "font") && (n = g(t, "face")) || (n = p(t, "font-family")), "[font=" + E(n) + "]" + e + "[/font]"
                },
            ...
            size: {
                ...
                format: function(t, e) {
                    var n = g(t, "size"),
                        r = 2;
                    return n || (n = p(t, "fontSize")), -1 < n.indexOf("px") ? ((n = n.replace("px", "") - 0) < 12 && (r = 1), 15 < n && (r = 3), 17 < n && (r = 4), 23 < n && (r = 5), 31 < n && (r = 6), 47 < n && (r = 7)) : r = n, "[size=" + r + "]" + e + "[/size]"
                },
            ...
            color: {
                ...
                format: function(t, e) {
                    var n;
                    return v(t, "font") && (n = g(t, "color")) || (n = t.style.color || p(t, "color")), "[color=" + c(n) + "]" + e + "[/color]"
                },
                html: function(t, e, n) {
            ...
            img: {
                ...
                html: function(t, e, n) {
                    var r, i, l, o = "";
                    return r = e.width, i = e.height, e.defaultattr && (r = (l = e.defaultattr.split(/x/i))[0], i = 2 === l.length ? l[1] : l[0]), void 0 !== r && (o += ' width="' + h(r, !0) + '"'), void 0 !== i && (o += ' height="' + h(i, !0) + '"'), "<img" + o + ' src="' + a(n) + '" />'
                }
            },
            url: {
                allowsEmpty: !0,
                ...
                html: function(t, e, n) {
                    return e.defaultattr = h(e.defaultattr, !0) || n, '<a href="' + a(e.defaultattr) + '">' + n + "</a>"
                }
            },
            email: {
                quoteType: x.never,
            ...
            quote: {
                ...
                quoteType: x.never,
                format: function(t, e) {
                    for (var n, r = "data-author", i = "", l = t.children, o = 0; !n && o < l.length; o++) v(l[o], "cite") && (n = l[o]);
                ...
                html: function(t, e, n) {
                    return e.defaultattr && (n = "<cite>" + h(e.defaultattr) + "</cite>" + n), "<blockquote>" + n + "</blockquote>"
                }
            },
            code: {
                tags: {
    ...
    function w(t, r) {
        return t.replace(/\{([^}]+)\}/g, function(t, e) {
            var n = !0;
            return "!" === e.charAt(0) && (n = !1, e = e.substring(1)), "0" === e && (n = !1), void 0 === r[e] ? t : n ? h(r[e], !0) : r[e]
        })
    }
    ...
    function q(t) {
        ...
        function o(t, e) {
            var n, r, i;
            return t === I && (n = e.match(/\[([^\]\s=]+)(?:([^\]]+))?\]/)) && (i = l(n[1]), n[2] && (n[2] = n[2].trim()) && (r = function(t) {
                var e, n = /([^\s=]+)=(?:(?:(["'])((?:\\\2|[^\2])*?)\2)|((?:.(?!\s\S+=))*.))/g,
                    r = {};
                if ("=" === t.charAt(0) && t.indexOf("=", 1) < 0) r.defaultattr = E(t.substr(1));
                else
                    for ("=" === t.charAt(0) && (t = "defaultattr" + t); e = n.exec(t);) r[l(e[1])] = E(e[3]) || e[4];
                return r
            }(n[2]))), t === L && (n = e.match(/\[\/([^\[\]]+)\]/)) && (i = l(n[1])), t === S && (i = "#newline"), i && (t !== I && t !== L || k[i]) || (t = T, i = "#"), new u(t, i, e, r)
        }
        ...
        m.opts = n({}, q.defaults, t), m.tokenize = function(t) {
            var e, n, r, i = [],
                l = [{
                    type: T,
                    regex: /^([^\[\r\n]+|\[)/
            ...
            var n = function(t) {
                    ...
                    for (; e = t.shift();) switch (o = t[0], p(c(), e) || e.type === L && c() && e.name === c().name || (e.name = "#", e.type = T), e.type) {
                        case I:
                            h(e.name) && u.pop(), f(e), (n = k[e.name]) && !n.isSelfClosing && (n.closedBy || d(e.name, L, t)) ? u.push(e) : n && n.isSelfClosing || (e.type = T);
                            break;
                        case L:
                            if (c() && e.name !== c().name && h("/" + e.name) && u.pop(), c() && e.name === c().name) c().closing = e, u.pop();
                                ...
                                for (o && o.type === S && (n = k[e.name]) && !1 === n.isInline && (f(o), t.shift()), f(v(a)), l = a.length; l--;) u.push(a[l]);
                                a.length = 0
                            } else e.type = T, f(e);
                            break;
                        case S:
                            c() && o && h((o.type === L ? "/" : "") + o.name) && (o.type === L && o.name === c().name || ((n = k[c().name]) && n.breakAfter ? u.pop() : n && !1 === n.isInline && m.opts.breakAfterBlock && !1 !== n.breakAfter && u.pop())), f(e);
                            break;
                        default:
                            f(e)
                    }
            ...
            return r.fixInvalidNesting && function t(e, n, r, i) {
                    ...
                    for (o = 0; o < e.length; o++)
                        if ((l = e[o]) && l.type === I) {
                            if (r && !f(l)) {
                                if (a = v(n), c = a.splitAt(l), u = 1 < n.length ? n[n.length - 2].children : i, p(l, a)) {
                                    var h = a.clone();
                                ...
                                if (-1 < (s = u.indexOf(a))) {
                                    ...
                                    var d = c.children[0];
                                    return void(d && d.type === S && (f(l) || (c.children.splice(0, 1), u.splice(s + 2, 0, d))))
                                }
                            }
                ...
                function t(e, n, r) {
                    ...
                    var l = e.length;
                    for (; l--;)(n = e[l]) && n.type === I && (r = k[n.name], t(n.children), i(n.children) && r && !r.isSelfClosing && !r.allowsEmpty && e.splice.apply(e, [l, 1].concat(n.children)))
                }(n), n
            ...
            return function t(e, n) {
                ...
                for (; 0 < e.length;)
                    if (r = e.shift()) {
                        if (r.type === I) c = r.children[r.children.length - 1] || {}, i = k[r.name], a = n && u(i), l = t(r.children, !1), i && i.html ? (u(i) || !u(k[c.name]) || i.isPreFormatted || i.skipLastLineBreak || b || (l += "<br />"), B(i.html) ? o = i.html.call(m, r, r.attrs, l) : (r.attrs[0] = l, o = w(i.html, r.attrs))) : o = r.val + l + (r.closing ? r.closing.val : "");
                        else {
                            if (r.type === S) {
                                if (!n) {
                                    f.push("<br />");
                                ...
                                s || f.push("<div>"), b || f.push("<br />"), e.length || f.push("<br />"), f.push("</div>\n"), s = !1;
                                continue
                            }
                            a = n, o = h(r.val, !0)
                        }
            ...
            return function t(e) {
                ...
                for (; 0 < e.length;)
                    if (n = e.shift())
                        if (i = k[n.name], l = !(!i || !1 !== i.isInline), o = i && i.isSelfClosing, s = l && m.opts.breakBeforeBlock && !1 !== i.breakBefore || i && i.breakBefore, u = l && !o && m.opts.breakStartBlock && !1 !== i.breakStart || i && i.breakStart, c = l && m.opts.breakEndBlock && !1 !== i.breakEnd || i && i.breakEnd, f = l && m.opts.breakAfterBlock && !1 !== i.breakAfter || i && i.breakAfter, a = (i ? i.quoteType : null) || m.opts.quoteType || x.auto, i || n.type !== I)
                            if (n.type === I) {
                                if (s && h.push("\n"), h.push("[" + n.name), n.attrs)
                                    for (r in n.attrs.defaultattr && (h.push("=", g(n.attrs.defaultattr, a, "defaultattr")), delete n.attrs.defaultattr), n.attrs) n.attrs.hasOwnProperty(r) && h.push(" ", r, "=", g(n.attrs[r], a, r));
    ...
    function f() {
        ...
        function f(n, r, t) {
            ...
            return a[t = !!t] && s(a[t], function(t, e) {
                (i = o(n, t)) && o(n.parentNode, t) !== i && s(e, function(t, e) {
                    (!e || -1 < e.indexOf(i.toString())) && (l = k[t].format, r = B(l) ? l.call(u, n, r) : C(l, r))
                })
            }), r
        }
        ...
        function h(n, r, t) {
            ...
            return t = !!t, o[e] && o[e][t] && s(o[e][t], function(t, e) {
                e && (i = !1, s(e, function(t, e) {
                    if (g(n, t) && !(e && e.indexOf(g(n, t)) < 0)) return !(i = !0)
                }), !i) || (l = k[t].format, r = B(l) ? l.call(u, n, r) : C(l, r))
            }), r
        }
            ...
            var u = function(t, a) {
                ...
                return m.traverse(t, function(t) {
                    var e = "",
                        ...
                        l = t.firstChild,
                        o = !0;
                    if ("object" == typeof a && (o = -1 < a.indexOf(r), v(t, "img") && g(t, y) && (o = !0), o || (i = a)), 3 === n || 1 === n)
                        if (1 === n) {
                            if (v(t, ".sceditor-nlf") && (!l || !b && 1 === t.childNodes.length && /br/i.test(l.nodeName))) return;
                            "iframe" !== r && (e = u(t, i)), o ? ("code" !== r && (e = f(t, e = h(t, e = f(t, e)), !0)), e = h(t, e, !0), s += function(t, e) {
                                var n = t.nodeName.toLowerCase(),
                                    r = m.isInline;
                                if (!r(t, !0) || "br" === n) {
                                    for (var i, l, o = t.previousSibling; o && 1 === o.nodeType && !v(o, "br") && r(o, !0) && !o.firstChild;) o = o.previousSibling;
        ...
        function t(t, e, n) {
            ...
            return t || n ? (r = s, a = document.createElement("div"), o = function(t, e) {
                if (!m.hasStyling(t)) {
            ...
            }, p(a, "display", "none"), a.innerHTML = r.replace(/<\/div>\n/g, "</div>"), (i = a.firstChild) && v(i, "div") && o(i, !0), (i = a.lastChild) && v(i, "div") && o(i), a.innerHTML) : s
        }

        function e(t, e, n, r) {
            var i, l, o = (n = n || document).createElement("div"),
                a = n.createElement("div"),
                s = new q(u.opts.parserOptions);
            for (a.innerHTML = e, p(o, "visibility", "hidden"), o.appendChild(a), n.body.appendChild(o), t && (o.insertBefore(n.createTextNode("#"), o.firstChild), o.appendChild(n.createTextNode("#"))), r && p(a, "whiteSpace", p(r, "whiteSpace")), l = a.getElementsByClassName("sceditor-ignore"); l.length;) l[0].parentNode.removeChild(l[0]);
            return m.removeWhiteSpace(o), i = d(a), n.body.removeChild(o), i = s.toBBCode(i, !0), u.opts.bbcodeTrim && (i = i.trim()), i
        }
        u.init = function() {
            u.opts = this.opts, u.elementToBbcode = d, s(k, function(n) {
                var r, t = k[n].tags,
                    e = k[n].styles;
                t && s(t, function(t, e) {
                    r = !1 === k[n].isInline, o[t] = o[t] || {}, o[t][r] = o[t][r] || {}, o[t][r][n] = e
                }), e && s(e, function(t, e) {
                    r = !1 === k[n].isInline, a[r] = a[r] || {}, a[r][t] = a[r][t] || {}, a[r][t][n] = e
                })
            }), this.commands = n(!0, {}, i, this.commands), this.toBBCode = u.toSource, this.fromBBCode = u.toHtml
    ...
    }, f.formatBBCodeString = w, t.formats.bbcode = f, t.BBCodeParser = q
}(sceditor);