/* SCEditor v2.1.3 | (C) 2017, Sam Clarke | sceditor.com/license */ ! function(n) {
    ...
    n.plugins.dragdrop = function() {
            ...
            this.signalReady = function() {
                ...
                if (!("handlePaste" in A) || A.handlePaste) {
                    ...
                    for (var n = t.querySelectorAll("img"), r = 0; r < n.length; r++) {
                        ...
                        if (u.test(i.src)) {
                            var a = g(i.src);
                            a && l(a) ? o(a, f(i)) : i.parentNode.removeChild(i)
                        }
                    }
                    e.val = t.innerHTML
                }
        ...
        function l(e) {
            return !("application/x-moz-file" !== e.type && A.allowedTypes && A.allowedTypes.indexOf(e.type) < 0) && (!A.isAllowed || A.isAllowed(e))
        }
        ...
        function f(e) {
            ...
            function t(e) {
                ...
                t && ("string" == typeof e && t.insertAdjacentHTML("afterend", e), t.parentNode.removeChild(t))
            }
            return n.src = v, n.className = "sceditor-ignore", n.id = "sce-dragdrop-" + s++,
                function() {
        ...
        function e(e) {
            for (var t = e.dataTransfer, n = t.files.length || !t.items ? t.files : t.items, r = 0; r < n.length; r++)
                if ("string" === n[r].kind) return;
            "none" === a.style.display && (a.style.display = "block", i.className += " dnd"), e.preventDefault()
        }
