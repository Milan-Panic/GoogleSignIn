...
class Connect extends PDO{
    public function __construct(){
        parent::__construct("mysql:host=localhost;dbname=vm_google_login", 'milan', 'panic',
...
class Controller {
    function registerUser($email, $password){
        $db = new Connect;
        $checkUser = $db -> prepare("SELECT * FROM reg_users WHERE email=:email");
        ...
        if(!$info["email"]){
            $insertNewUser = $db -> prepare("INSERT INTO reg_users (email, password) VALUES (:email, :password)");
    ...
    function insertNew($email, $fname, $lname, $id, $avatar){
        $db = new Connect;
